...
import { getPersonalCourseCount, getPersonalSelectCount, getPersonalCourseCompletionRateAverage, getPersonalCourseCompletionRateRank, getPersonalCourseCompletionRateSectional } from '../../api/courseStatistic'
...
const loadCourseStats = async () => {
  ...
  try {
    ...
    courseStats.value = {
      courseCount: courseCountResponse.data,
      selectCount: selectCountResponse.data,
      completionRate: completionRateResponse.data
    }
  } catch (error) {
    ElMessage.error('获取课程统计数据失败：' + (error.message || '未知错误'))
  } finally {
    loading.value = false
  }
}
    ...
    <div class="stats-section">
      <el-card shadow="hover" class="stat-card">
        <div class="stat-content">
          ...
          <div class="stat-info">
            <div class="stat-number">{{ courseStats.courseCount }}</div>
      ...
      <el-card shadow="hover" class="stat-card">
        <div class="stat-content">
          ...
          <div class="stat-info">
            <div class="stat-number">{{ courseStats.selectCount }}</div>
